...
/*
 * 데이터베이스 설정을 위한 클래스임을 알리기 -> @configuration
 * 설정파일 위치를 알려줌  -> propertySource
 * mapper파일 선언
 * mybatis 설정들 -  sqlsessionfactory, sqlsessiontemplate 생성
 * (/src/main/resources/mybatis 폴더의 파일명이 "xml"로 끝나는 파일 매핑)
 * datasource를 만들기 위한 hikari 설정 파일의 접두사 선언 spring.datasource.hikari....
 * 
 */
@Configuration
