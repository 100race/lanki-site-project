...
//  public static String pagingBox(String listFile, int cateno, int totalRecord, int nowPage,
//		    String word) {
...
//	    if (nowGrp >= 2) {
//	      str.append("<li><a href='"+listFile+"?cateno=" + cateno + "&word=" + word + "&nowPage=" + _nowPage + "'>이전</A></li>");
//	    }
...
//	      } else {
//	        str.append("<li><a href='"+listFile+"?cateno=" + cateno + "&word=" + word + "&nowPage=" + i + "'>" + i + "</A></li>");
//	      }
//	    }
//	    _nowPage = (nowGrp * pagePerBlock) + 1; // 10개 다음 페이지로 이동
//	    if (nowGrp < totalGrp) {
//	      str.append("<li><A href='"+listFile+"?cateno=" + cateno + "&word=" + word + "&nowPage=" + _nowPage + "'>다음</A></li>");
//	    }
//	    str.append("</ul>");
//	    str.append("</div>");
//	    return str.toString();
